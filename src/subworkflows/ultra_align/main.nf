...
include { MINIMAP2_ALIGN as MINIMAP2_ALIGN_FRAGMENTS_ULTRA } from '../../modules/custom/minimap2/align/main.nf'
...
include { SAMTOOLS_BAM as SAMTOOLS_BAM_FRAGMENTS_ULTRA } from '../../modules/custom/samtools/bam/main.nf'
...
include { ISOTOOLS_ALIGN as ISOTOOLS_FIND_FRAGMENTS_ULTRA } from '../../modules/custom/isotools/align/main.nf'
...
workflow SPLIT_ULTRA_ALIGN_CLEAN_CHUNKS {
    ...
    main:
      ...
      if (do_second_pass) {
        ...
        MINIMAP2_ALIGN_FRAGMENTS_ULTRA(
          ISOTOOLS_FIND_FRAGMENTS_ULTRA.out.fasta,
          ch_minimap2_index,
          ch_splice_scores,
          ch_reference_transcripts
        )

        SAMTOOLS_BAM_FRAGMENTS_ULTRA(MINIMAP2_ALIGN_FRAGMENTS_ULTRA.out.sam)
        SAMTOOLS_BAM_FRAGMENTS_ULTRA.out.bam
            .join(SAMTOOLS_BAM_FRAGMENTS_ULTRA.out.bai)
